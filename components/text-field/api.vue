      ...
      <table class="api-table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>boolean</td>
            <td>false</td>
            <td>Create counter for input length;</td>
          </tr>
          <tr>
            <td>placeholder</td>
            <td>string</td>
            <td>undefined</td>
            <td>Sets the input’s placeholder text</td>
          </tr>
          <tr>
            <td>limit</td>
            <td>string</td>
            <td>undefined</td>
            <td>Sets the input’s maxlength</td>
          </tr>
          <tr>
            <td><b>prepend-icon</b></td>
            <td>string</td>
            <td>undefined</td>
            <td>
              Prepends an icon to the component, uses the same syntax
              <code class="code-line">e-icon</code>
            </td>
          </tr>
          <tr>
